...
const Main = (props: MainProps) => {
    ...
    const updateMessageStatus = (number: string) => {
        ...
        axios.get(`https://api.twilio.com/2010-04-01/Accounts/${settings.accountSID}/Messages/${phoneNumber.messageObject.sid}.json`,{auth: {username: settings.accountSID, password: settings.authToken}}).then((response: AxiosResponse) => {
    ...
    const sendMessages = () => {
        ...
        Object.values(phoneNumbers).forEach((phoneNumber) => {
            ...
            axios.post(`https://api.twilio.com/2010-04-01/Accounts/${settings.accountSID}/Messages.json`, bodyData,
                {
                    auth: {
